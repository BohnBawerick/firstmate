...
Resolve code-formatted resource paths against the skill directory, including paths named by a nested reference.
Markdown links resolve relative to the file containing the link.
