...
While away mode (`state/.afk`) is active, the sub-supervisor daemon owns supervision and triage; the Pi extension stands down so wakes and arm processes do not duplicate.
