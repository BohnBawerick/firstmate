...
The injection sits at the unconditional pre-launch export site, so it covers every supported harness and task kind; [harness support](configuration.md#harness-support) owns the supported combinations.
