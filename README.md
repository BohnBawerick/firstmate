...
- **Explicit project modes** - each project ships via `no-mistakes`, `direct-PR`, `local-only`, or one of those plus `+hardened` for the highest-rigor quality gate, with an optional `+yolo` merge-autonomy flag.
...
| Skill              | What it does                                                                                                                                  |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [`/afk`](.agents/skills/afk/SKILL.md) | Record your away instructions, keep supervision running, and present a catch-up brief when you return |
| [`/quiet`](.agents/skills/quiet/SKILL.md) | Batch routine updates while you stay and chat; ordinary messages preserve it until explicit `/quiet off` |
