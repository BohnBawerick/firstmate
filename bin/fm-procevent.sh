...
# repeats every supervision cycle is as unusable as one nobody gets.
...
# generation last reported as its first field.
# A caller may store more after that field (the launch-failure nonce);
