...
#     fm_nm_head_matches_worktree, the strict matching predicate built on
#     fm_nm_head_identity) both match this worktree, then runs
...
rm -f "$STATE/$ID.turn-ended" "$STATE/$ID.meta" \
  "$STATE/$ID.pi-ext.ts" "$STATE/$ID.muse-session" \
