...
It also runs every script contained under the resolved per-script wall-clock budget, so a script that stops making progress is terminated and named instead of stalling the lane.
